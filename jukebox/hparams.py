...
small_nvae = Hyperparams(
    ...
    num_latent_per_group=10,
    ada_groups=True,
    min_groups_per_scale=1,
    num_channels_enc=2,
    num_preprocess_blocks=3,
    num_preprocess_cells=4,
    num_cell_per_cond_enc=1,
    num_channels_dec=2,
    num_postprocess_blocks=3,
    num_postprocess_cells=4,
...
DEFAULTS["nvae"] = Hyperparams(
    ...
    min_groups_per_scale=1,
    num_channels_enc=2,
    num_preprocess_blocks=8,
    num_preprocess_cells=3,
    num_cell_per_cond_enc=1,
    num_channels_dec=2,
    num_postprocess_blocks=8,
    ...
    num_x_bits=16,
    dilation_growth_rate=3,
    normal_enc=['res_bnelu', 'res_bnelu1x1'],
    down_enc=['res_bnelu', 'res_bnelu1x1'],
    normal_dec=['res_bnelu1x1', 'res_bnelu'],
    up_dec=['res_bnelu1x1', 'res_bnelu'],
    normal_pre=['res_bnelu', 'res_bnelu1x1'],
    down_pre=['res_bnelu', 'res_bnelu1x1'],
    normal_post=['res_bnelu1x1', 'res_bnelu'],
    up_post=['res_bnelu1x1', 'res_bnelu'],
    ar_nn=[''],
)
