...
DEFAULTS["nvae"] = Hyperparams(
    ...
    cont_training=False,
    num_x_bits=16,
    normal_enc=['res_bnelu', 'res_bnelu'],
    down_enc=['res_bnelu', 'res_bnelu'],
    normal_dec=['res_bnelu', 'res_bnelu'],
    up_dec=['res_bnelu', 'res_bnelu'],
    normal_pre=['res_bnelu', 'res_bnelu'],
    down_pre=['res_bnelu', 'res_bnelu'],
    normal_post=['res_bnelu', 'res_bnelu'],
    up_post=['res_bnelu', 'res_bnelu'],
    ar_nn=[''],
)
